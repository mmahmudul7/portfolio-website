import profilePic from "../assets/Mahmud.png";
    ...
    >
      ...
      <div>
        <img
          src={profilePic}
          alt="profile"
          className="w-48 h-48 md:w-64 md:h-64 bg-gray-100 rounded-full object-cover shadow-lg border-4 border-yellow-500"
        />
      </div>
    </section>
  );
